...
image1 = cv2.imread("depth_files/ladder/im0.png")
image2 = cv2.imread("depth_files/ladder/im1.png")
...
k_l = np.array([[1734.16 ,0, 333.49],[0, 1734.16, 958.05],[0,0,1]])
k_r = np.array([[1734.16 ,0, 333.49],[0, 1734.16, 958.05],[0,0,1]])
#image shapes 
...
def compute_essential_matrix(F,k_l,k_r):
    ...
    print("The Essential Matrix for Ladder Dataset is:")
    print(E)
    return E
...
def sift_matcher(img1,img2,image1_color,image2_color):
    ...
    cv2.imwrite("ladder/SIFTMatchingPoints.jpg",sift_matches)
...
print("The Fundamental Matrix for Ladder dataset is :")
print(F)
...
print("Rotation matrix for Ladder dataset is:")
print(R_final)
print("Translation matrix for Ladder dataset is:")
print(T_final)
...
cv2.imwrite("ladder/LeftEpilineBefore.jpg",left_img1)
image1_copy = image1.copy()
image2_copy = image2.copy()
...
cv2.imwrite("ladder/RightEpilineBefore.jpg",right_img1)
epi_img = np.concatenate((left_img1,right_img1),axis=1)
cv2.imwrite("ladder/InitialEpiline.jpg",epi_img)
...
cv2.imwrite("ladder/left_epiline.jpg",left_img1_r)
image1_copy = image1.copy()
image2_copy = image2.copy()
...
cv2.imwrite("ladder/right_epiline.jpg",right_img1)
epi_img_r = np.concatenate((left_img1_r,right_img1_r),axis=1)
cv2.imwrite("ladder/epiline.jpg",epi_img_r)
...
cv2.imwrite("ladder/DisparityMap.jpg",disparity_map)
cv2.imwrite("ladder/DisparityHeatMap.jpg",disparity_heatmap)
